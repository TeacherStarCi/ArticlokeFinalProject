        ...
        <section class ="starci-full-container starci-img2-background">
            <section class = "starci-section-container-container">
                ...
                <div class ="p-4 starci-center starci-rounded shadow position-absolute" style ="width: 30%; background: #EADACD">
                    ...
                    <form action = "CreateThisServlet" id = "CreateThisServlet" method = "get">                 
                    </form>
                    ...
                    <div class="form-floating mt-5">
                        <input form = "CreateThisServlet" type="text" class="form-control" id="floatingInput" name = "username" value = "${requestScope.username}" placeholder="name@example.com" >
                    ...
                    <div class="form-floating mt-3">
                        <input form = "CreateThisServlet" type="password" class="form-control" id="floatingInput" name = "password" placeholder="name@example.com" >
                    ...
                    <div class="form-floating mt-3">
                        <input form = "CreateThisServlet" type="password" class="form-control" id="floatingInput" name = "confirm" value = "" placeholder="name@example.com" >
                    ...
                    <div class="form-floating mt-3">
                        <select form = "CreateThisServlet" class="form-control" id="floatingInput" name = "role" placeholder="name@example.com" >
                    ...
                    <div class ="d-flex mt-3">
                        <section class = "me-3 flex-fill">   <div class="form-floating">
                                <input form = "CreateThisServlet" type="text" class="form-control" id="floatingInput" name = "firstName" value = "${requestScope.firstName}" placeholder="name@example.com" >
                        ...
                        <section> 
                            <div class="form-floating">
                                <input form = "CreateThisServlet" type="text" class="form-control" id="floatingInput" name = "lastName" value = "${requestScope.lastName}" placeholder="name@example.com" >
                    ...
                    <div class ="row mt-3"> 
                        <div class ="col-2 position-relative">
                            <input style = "width: 2rem; height: 2rem" class = "position-absolute starci-center" form ="CreateThisServlet" name ="term" class = "vertical-center mr-3" type = "checkbox" value = "checked">
                        </div>
                        <div class ="col-10">
                    ...
                    <button form = "CreateThisServlet" class ="btn btn-lg mt-3 starci-horizontal-center starci-button-sp starci-background position-relative me-3" name = "action" value = "Create"> <span class = "h5"> Create </span></button>
