...
public class RepositoryCoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                articles = ArticleDAO.getArticlesKeywordTopic(username, keyword, topic);
            } catch (SQLException | ClassNotFoundException ex) {
            }
            request.setAttribute("articles", articles);
            try {
                pendingPapers = PaperDAO.getPapersKeywordTopic(username, keyword, topic, "Pending");
            } catch (SQLException | ClassNotFoundException ex) {
            }
            ...
            try {
                approvedPapers = PaperDAO.getPapersKeywordTopic(username, keyword, topic, "Approved");
            } catch (SQLException | ClassNotFoundException ex) {
            }
            ...
            try {
                draftPapers = PaperDAO.getPapersKeywordTopic(username, keyword, topic, "Draft");
            } catch (SQLException | ClassNotFoundException ex) {
            }
